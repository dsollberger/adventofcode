...
```{r}
# I simply loaded the data into Excel
# sorted the "Used" and "Avail" columns
# observed that there was only one node with sufficient space
# and that that node could handle the data in 1007 nodes
```
